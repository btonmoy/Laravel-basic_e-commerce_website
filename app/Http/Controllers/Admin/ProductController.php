    ...
    public function manage_product_process(Request $request)
    {
     ...
     //  Image Images Start
        ...
        foreach($piidArr as $key=>$val){
            $productImagesrArr['products_id']=$pid;
            ...
            if($request->hasFile("images.$key")){
                ...
                //  $rand=rand('111111111','999999999');
                 ...
                 $productImagesrArr['images']=$image_name;

                 if($piidArr[$key]!=''){
                    DB::table('product_images')->where(['id'=>$piidArr[$key]])->update($productImagesrArr);
                 }else{
                    DB::table('product_images')->insert($productImagesrArr);
                 }

             }
             
            //  else{
            //     $productImagesrArr['images']='';
            //      }
           }
