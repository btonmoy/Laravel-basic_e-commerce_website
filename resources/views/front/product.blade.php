        ...
        <div class="col-md-12">
          <div class="aa-product-details-area">
                    ...
                    <div id="demo-1" class="simpleLens-gallery-container">
                      <div class="simpleLens-container">
                        <div class="simpleLens-big-image-container">
                          <a data-lens-image="{{asset('storage/media/'.$product[0]->image)}}" class="simpleLens-lens-image">
                      ...
                      <div class="simpleLens-thumbnails-container">
                          ...
                          <a data-big-image="{{asset('storage/media/'.$list->images)}}" data-lens-image="{{asset('storage/media/'.$list->images)}}" 
                ...
                <div class="col-md-7 col-sm-7 col-xs-12">
                  <div class="aa-product-view-content">
                    ...
                    <div class="aa-price-block">
                      <span class="aa-product-view-price"><del>Rs {{$product_attr[$product[0]->id][0]->mrp}}</del>&nbsp &nbsp &nbsp </span>
            ...
            <div class="aa-product-related-item">
              ...
              <span class="aa-product-price">Rs {{$related_product_attr[$productArr->id][0]->price}} &nbsp &nbsp &nbsp</span>
